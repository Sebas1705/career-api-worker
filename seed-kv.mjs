/**
 * Seeds the Cloudflare KV namespace with all career data.
 * Run: node seed-kv.mjs
 *
 * All localizable fields use { [langCode]: value } — add new language codes
 * by extending each LocalizedString object and updating /languages.
 */
...
// ── Schema convention ─────────────────────────────────────────────────────────
// LocalizedString = { en: "...", es: "...", [anyLangCode]: "..." }
// To add a language: extend every LocalizedString field + add the code to SEED.languages.

const SEED = {

  // ── Supported languages ────────────────────────────────────────────────────
  // Consumers use GET /languages to build a language switcher.
  // PUT /languages (auth) to add/remove languages.
  languages: {
    default: 'en',
    supported: [
  ...
  // ── Personal (singular) ────────────────────────────────────────────────────
  // Non-localizable fields: name, email, cv_url, github, linkedin, codewars
  // Localizable fields use LocalizedString objects.
  personal: {
    ...
    role:     { en: 'Full Stack & Mobile Developer',
                es: 'Desarrollador Full Stack & Movil'                      },
    tagline:  { en: 'Full stack and mobile engineer: design fast frontends, solid APIs and production-ready mobile experiences.',
                es: 'Ingeniero full stack y movil: diseno frontends rapidos, APIs solidas y experiencias moviles listas para produccion.' },
    bio:      { en: 'Based in Madrid, Spain. I build digital products with care — from native mobile apps to full-stack web systems.',
                es: 'Con base en Madrid, Espana. Construyo productos digitales con cuidado — desde apps moviles nativas hasta sistemas web full-stack.' },
    location: { en: 'Madrid, Spain', es: 'Madrid, Espana'                  },
  },

  // ── Jobs ──────────────────────────────────────────────────────────────────
  // Localizable: role, type, desc, projects[].name, achievements[].text
  jobs: [
    {
      id:         'senior-solusoft',
      company:    'Solusoft',
      ...
      startDate:  '2026-01',
      endDate:    null,
      role:       { en: 'Senior Full Stack & Mobile Developer',  es: 'Senior Desarrollador Full Stack & Movil' },
      type:       { en: 'Hybrid',                                es: 'Hibrido'                                  },
      period:     { en: 'January 2026 - Present',                es: 'Enero 2026 - Presente'                   },
      desc:       { en: 'Leading development and architectural decisions.',
                    es: 'Liderazgo tecnico y de decisiones arquitectonicas.'                                   },
      projects: ['AGEDI', 'Sisley', 'Iberext', 'EPDM', 'ApiMovil', 'Wemob', 'Transportes Chinchón'],
      achievements: {
        en: ['Promoted to Senior within the same team',
             'Led architectural refactors across multiple projects',
             'Drove adoption of clean multimodular architecture',
             'Continued full ownership of EPDM and Iberext lifecycle'],
        es: ['Promocion a Senior dentro del mismo equipo',
             'Lidere refactorizaciones arquitectonicas en multiples proyectos',
             'Impulse la arquitectura limpia y multimodular',
             'Ownership completo de EPDM e Iberext'],
      },
    },
    {
      id:         'junior-solusoft',
      ...
      startDate:  '2025-03',
      endDate:    '2025-12',
      role:       { en: 'Junior Full Stack & Mobile Developer',  es: 'Junior Desarrollador Full Stack & Movil' },
      type:       { en: 'Hybrid',                                es: 'Hibrido'                                  },
      ...
      desc:       { en: 'Development and maintenance following agile methodologies.',
                    es: 'Desarrollo y mantenimiento siguiendo metodologias agiles.'                            },
      projects: ['AGEDI', 'Sisley', 'Iberext', 'EPDM'],
      achievements: {
        en: ['Full development of EPDM mobile app published on Play Store',
             'Built Iberext mobile app from scratch'],
        es: ['Desarrollo completo de la app EPDM publicada en Play Store',
             'Desarrollo desde cero de Iberext'],
      },
    },
    {
      id:         'intern-solusoft',
      ...
      startDate:  '2024-10',
      endDate:    '2025-02',
      role:       { en: 'Full Stack & Mobile Developer Intern',  es: 'Practicas Desarrollador Full Stack & Movil' },
      type:       { en: 'Hybrid',                                es: 'Hibrido'                                    },
      period:     { en: 'October 2024 - February 2025',          es: 'Octubre 2024 - Febrero 2025'               },
      desc:       { en: 'Supervised learning and development.',
                    es: 'Aprendizaje y desarrollo bajo supervision.'                                            },
      projects: ['AGEDI', 'Sisley', 'Iberext'],
      achievements: {
        en: ['Implemented new features across AGEDI projects',
             'Maintenance of Sisley frontend and backend',
             'Built Iberext mobile app from scratch'],
        es: ['Implemente nuevas funcionalidades en AGEDI',
             'Mantenimiento de Sisley',
             'Desarrollo desde cero de Iberext'],
      },
    },
  ],
  ...
  // ── Projects ───────────────────────────────────────────────────────────────
  // Localizable: desc
  // Non-localizable: id, name, context, tags, github, demo
  projects: [
    { id: 'agedi',          name: 'AGEDI System',           context: 'work',
      desc: { en: 'Enterprise management platform for AGEDI.',                            es: 'Plataforma de gestion empresarial para AGEDI.'                    },
      tags: ['C#', '.NET', 'SQL Server', 'Azure', 'Power BI', 'JavaScript'],              github: null,                                                           demo: null },
    { id: 'axiomnode',      name: 'AxiomNode',              context: 'academic',
      desc: { en: "Master's TFM: production-grade microservices platform.",               es: 'TFM del Master: plataforma de microservicios.'                    },
    ...
    { id: 'sisley',         name: 'Sisley System',          context: 'work',
      desc: { en: 'Web application for Sisley content management.',                       es: 'Aplicacion web para gestion de contenido de Sisley.'             },
      tags: ['C#', '.NET', 'SQL Server', 'Azure', 'MVC'],                                 github: null,                                                           demo: null },
    { id: 'youknow',        name: 'YouKnow',                context: 'academic',
      desc: { en: 'Android social network app for educational games.',                    es: 'App Android de red social para juegos educativos.'               },
    ...
    { id: 'iberext',        name: 'Iberext System',         context: 'work',
      desc: { en: 'Android app for fire prevention systems.',                             es: 'App Android para sistemas de prevencion de incendios.'           },
    ...
    { id: 'impostor',       name: 'Omni-Impostor',          context: 'personal',
      desc: { en: 'Native Android game with multimodular architecture.',                  es: 'Juego Android nativo con arquitectura multimodular.'             },
    ...
    { id: 'epdm',           name: 'EPDM Music Portal',      context: 'work',
      desc: { en: 'Android app for managing music content with AGEDI rights.',            es: 'App Android para gestionar contenido musical de AGEDI.'          },
    ...
    { id: 'vpsorchestrator', name: 'Local VPS Orchestrator', context: 'academic',
      desc: { en: 'REST API to orchestrate VPS resources with RBAC and 555 automated tests.', es: 'API REST para orquestar recursos VPS con RBAC y 555 tests.' },
    ...
    { id: 'portfolio',      name: 'Personal Portfolio v1',  context: 'personal',
      desc: { en: 'Previous portfolio: Astro + Clean Architecture, 14 locales.',          es: 'Portafolio anterior: Astro + Arquitectura Limpia, 14 idiomas.'   },
    ...
    { id: 'chinchon-android', name: 'Transportes Chinchón Android', context: 'work',
      desc: { en: 'Native Android app for Transportes Chinchón.',                         es: 'App Android nativa para Transportes Chinchón.'                   },
      tags: ['Kotlin', 'Jetpack Compose', 'Android'],                                    github: null,                                                           demo: null },
    { id: 'chinchon-ios',   name: 'Transportes Chinchón iOS', context: 'work',
      desc: { en: 'Native iOS app for Transportes Chinchón.',                             es: 'App iOS nativa para Transportes Chinchón.'                       },
    ...
    { id: 'templetry',      name: 'Templetry',              context: 'personal',
      desc: { en: 'Project scaffolding for every platform: pure Go engine + CLI, native desktop app (Wails) and a CI-verified template catalog.',
              es: 'Scaffolding de proyectos multiplataforma: engine en Go + CLI, app de escritorio nativa (Wails) y catálogo de plantillas verificado por CI.' },
    ...
    { id: 'career-ecosystem', name: 'Career Ecosystem (Folio)', context: 'personal',
      desc: { en: 'Portfolio as a product: Cloudflare Workers API as single source of truth, React portfolio and a KMP editor for Android and Desktop.',
              es: 'Portfolio como producto: API en Cloudflare Workers como fuente única de verdad, portfolio en React y editor KMP para Android y Escritorio.' },
    ...
    { id: 'kmp-native-base', name: 'KMP Native Base',       context: 'personal',
      desc: { en: 'Kotlin Multiplatform template — Android + Desktop + iOS — modular clean architecture, convention plugins and CI.',
              es: 'Plantilla Kotlin Multiplatform — Android + Desktop + iOS — arquitectura limpia modular, convention plugins y CI.' },
    ...
    { id: 'profesores-a-casa', name: 'TutorsAtHome',        context: 'academic',
      desc: { en: 'Distributed web app connecting private tutors with students — Spring Boot, RabbitMQ, HAProxy, Docker.',
              es: 'App web distribuida que conecta profesores particulares con alumnos — Spring Boot, RabbitMQ, HAProxy, Docker.' },
    ...
    { id: 'computer-vision-labs', name: 'Computer Vision Labs', context: 'academic',
      desc: { en: 'Road sign detection (MSER + HSV) and OCR pipeline (LDA/PCA + sklearn) in Python/OpenCV.',
              es: 'Detección de señales de tráfico (MSER + HSV) y pipeline OCR (LDA/PCA + sklearn) en Python/OpenCV.' },
    ...
    { id: 'enigma',         name: 'Enigma HPC',             context: 'academic',
      desc: { en: 'Parallel Enigma machine decryption in C++ — MPI master-slave vs sequential/OpenMP.',
              es: 'Descifrado paralelo de la máquina Enigma en C++ — MPI maestro-esclavo vs secuencial/OpenMP.' },
      tags: ['C++', 'MPI', 'OpenMP', 'HPC'],                                             github: 'https://github.com/Sebas1705/Enigma',                         demo: null },
  ],

  // ── Education ──────────────────────────────────────────────────────────────
  // Localizable: degree, period, detail
  // Non-localizable: id, school, icon
  education: [
    {
      id:     'big-school',
      school: 'BigSchool & Isabel I University',
      icon:   'graduation',
      degree: { en: "Master's in AI Development",    es: 'Master de Desarrollo con IA'  },
      period: { en: 'October 2025 - June 2026',      es: 'Octubre 2025 - Junio 2026'   },
      detail: { en: '11-module postgraduate: Software Engineering, Architecture, AI, DevSecOps.',
                es: 'Posgrado de 11 modulos: Ingenieria de Software, Arquitectura, IA, DevSecOps.' },
    },
    {
      id:     'urjc',
      school: 'Universidad Rey Juan Carlos',
      icon:   'university',
      degree: { en: 'Computer Engineering',          es: 'Ingenieria de Computadores'   },
      period: { en: 'September 2020 - July 2025',    es: 'Septiembre 2020 - Julio 2025' },
      detail: { en: 'Information Technology degree. Mostoles, Madrid. TFG: YouKnow.',
                es: 'Grado en Informatica. Mostoles, Madrid. TFG: YouKnow.'              },
    },
    {
      id:     'baccalaureate',
      school: 'IES Maestro Matias Bravo',
      icon:   'school',
      degree: { en: 'Baccalaureate - Technology',    es: 'Bachillerato - Tecnologico'   },
      period: { en: 'Sept 2018 - June 2020',         es: 'Sept 2018 - Junio 2020'       },
      detail: { en: 'Valdemoro, Madrid, Spain.',     es: 'Valdemoro, Madrid, Espana.'   },
    },
  ],

  // ── Certifications ─────────────────────────────────────────────────────────
  // Non-localizable: all (certification names are proper nouns)
  certifications: [
  ...
  // Non-localizable: id
  'soft-skills': [
    { id: 'adaptability',      name: { en: 'Adaptability',       es: 'Adaptabilidad'         } },
    { id: 'attention-detail',  name: { en: 'Attention to Detail',es: 'Atencion al detalle'   } },
    { id: 'communication',     name: { en: 'Communication',      es: 'Comunicacion'          } },
    { id: 'cont-learning',     name: { en: 'Continuous Learning',es: 'Aprendizaje continuo'  } },
    { id: 'creativity',        name: { en: 'Creativity',         es: 'Creatividad'           } },
    { id: 'critical-thinking', name: { en: 'Critical Thinking',  es: 'Pensamiento critico'   } },
    { id: 'empathy',           name: { en: 'Empathy',            es: 'Empatia'               } },
    { id: 'proactivity',       name: { en: 'Proactivity',        es: 'Proactividad'          } },
    { id: 'problem-solving',   name: { en: 'Problem Solving',    es: 'Resolucion de problemas'} },
    { id: 'resilience',        name: { en: 'Resilience',         es: 'Resiliencia'           } },
    { id: 'teamwork',          name: { en: 'Teamwork',           es: 'Trabajo en equipo'     } },
    { id: 'time-management',   name: { en: 'Time Management',    es: 'Gestion del tiempo'    } },
  ],
}
...
for (const [key, value] of Object.entries(SEED)) {
  ...
  process.stdout.write(`Seeding ${key} (${json.length} bytes)... `)
  const cmd = `npx wrangler kv key put --namespace-id=${KV_ID} --remote --path="${tmpFile}" "${key}"`
  try {
    execSync(cmd, { cwd: 'C:\\Users\\sebss\\Documents\\career-api-worker', stdio: ['pipe', 'pipe', 'pipe'] })
    console.log('OK')
  } catch (e) {
    console.error('FAIL:', e.stderr?.toString() || e.message)
  } finally {
