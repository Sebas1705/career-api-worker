...
export const SEED = {
  ...
  projects: [
    ...
    { id: 'apimovil',       name: 'ApiMovil',                context: 'work',
      desc: { en: 'Internal .NET API powering the Transportes Chinchón mobile applications.',     es: 'API .NET interna que da servicio a las aplicaciones móviles de Transportes Chinchón.' } as LocalizedString,
